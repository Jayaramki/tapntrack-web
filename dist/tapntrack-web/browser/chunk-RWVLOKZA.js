...
`,bn={root:"p-ink"},He=(()=>{class o extends I{name="ripple";style=pn;classes=bn;static \u0275fac=(()=>{let t;return function(n){return(t||(t=f(o)))(n||o)}})();static \u0275prov=T({token:o,factory:o.\u0275fac})}return o})();var je=(()=>{class o extends k{componentName="Ripple";zone=d(Zt);_componentStyle=d(He);animationListener;mouseDownListener;timeout;constructor(){super(),w(()=>{K(this.platformId)&&(this.config.ripple()?this.zone.runOutsideAngular(()=>{this.create(),this.mouseDownListener=this.renderer.listen(this.el.nativeElement,"mousedown",this.onMouseDown.bind(this))}):this.remove())})}onAfterViewInit(){}onMouseDown(t){let e=this.getInk();if(!e||this.document.defaultView?.getComputedStyle(e,null).display==="none")return;if(!this.$unstyled()&&tt(e,"p-ink-active"),e.setAttribute("data-p-ink-active","false"),!At(e)&&!Ot(e)){let s=Math.max(me(this.el.nativeElement),ve(this.el.nativeElement));e.style.height=s+"px",e.style.width=s+"px"}let n=ye(this.el.nativeElement),i=t.pageX-n.left+this.document.body.scrollTop-Ot(e)/2,r=t.pageY-n.top+this.document.body.scrollLeft-At(e)/2;this.renderer.setStyle(e,"top",r+"px"),this.renderer.setStyle(e,"left",i+"px"),!this.$unstyled()&&ut(e,"p-ink-active"),e.setAttribute("data-p-ink-active","true"),this.timeout=setTimeout(()=>{let s=this.getInk();s&&(!this.$unstyled()&&tt(s,"p-ink-active"),s.setAttribute("data-p-ink-active","false"))},401)}getInk(){let t=this.el.nativeElement.children;for(let e=0;e<t.length;e++)if(typeof t[e].className=="string"&&t[e].className.indexOf("p-ink")!==-1)return t[e];return null}resetInk(){let t=this.getInk();t&&(!this.$unstyled()&&tt(t,"p-ink-active"),t.setAttribute("data-p-ink-active","false"))}onAnimationEnd(t){this.timeout&&clearTimeout(this.timeout),!this.$unstyled()&&tt(t.currentTarget,"p-ink-active"),t.currentTarget.setAttribute("data-p-ink-active","false")}create(){let t=this.renderer.createElement("span");this.renderer.addClass(t,"p-ink"),this.renderer.appendChild(this.el.nativeElement,t),this.renderer.setAttribute(t,"data-p-ink","true"),this.renderer.setAttribute(t,"data-p-ink-active","false"),this.renderer.setAttribute(t,"aria-hidden","true"),this.renderer.setAttribute(t,"role","presentation"),this.animationListener||(this.animationListener=this.renderer.listen(t,"animationend",this.onAnimationEnd.bind(this)))}remove(){let t=this.getInk();t&&(this.mouseDownListener&&this.mouseDownListener(),this.animationListener&&this.animationListener(),this.mouseDownListener=null,this.animationListener=null,Ce(t))}onDestroy(){this.config&&this.config.ripple()&&this.remove()}static \u0275fac=function(e){return new(e||o)};static \u0275dir=P({type:o,selectors:[["","pRipple",""]],hostAttrs:[1,"p-ripple"],features:[x([He]),v]})}return o})(),ui=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275mod=M({type:o});static \u0275inj=$({})}return o})();var Re=`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
